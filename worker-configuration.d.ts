/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 92d1a4bb20153a3e35a3e9ebe408eeef)
// Runtime types generated with workerd@1.20260317.1 2026-03-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/app");
	}
	interface Env {
		DAILY_DIFF: KVNamespace;
		DailyDiffEmail: SendEmail;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CF_WORKERS_API_TOKEN" | "GH_TOKEN" | "GH_API_URL" | "GH_REPO_OWNER" | "GH_AUTHOR" | "JWT_SECRET" | "VALID_EMAIL" | "VALID_PASSWORD">> {}
}
